<template>
  ...
  <el-container>
    <el-header>
			...
			<div>
				<i class="el-input__icon el-icon-search" @click="flag=!flag"></i>
				<el-autocomplete
...
></el-autocomplete>
				...
				<!-- <img src="../assets/1BEB380FDDE549FE18C7F5420978780E.jpg" alt="" style="width:50px;height:50px;border-radius: 50%;"> -->
				<p>{{}}</p>
				<el-dropdown>
