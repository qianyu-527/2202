<template>
	<div>
		<div class="box">
			<div><img src="../../assets/1BEB380FDDE549FE18C7F5420978780E.jpg" alt=""></img></div>
			<div>
				<p>早安,{{}},祝你开心每一天!</p>
				<p style="color: #ccc;">{{}}| 传智播客 - 总裁办</p>
			</div>
		</div>
			<div class="title">
				<div class="left">
			...
			<div class="top">
				...
				<hr/>
				<div>
					<el-button size="mini">加班离职</el-button>
					<el-button size="mini">请假调休</el-button>
					<el-button size="mini">审批列表</el-button>
					<el-button size="mini">我的信息</el-button>
				</div>
			</div>
			<div class="cen">
